...
return [
    ...
    'hero' => [
        ...
        'title' => 'Bangun Sistem Digital yang',
        'highlight' => 'Rapi, Cepat, dan Siap Scale.',
        'description' => 'Kami membantu bisnis, sekolah, dan organisasi membangun website, dashboard, sistem manajemen, hingga integrasi yang efisien dan siap mendukung pertumbuhan Anda.',
        'stats' => [
            ['value' => '35+', 'label' => 'Project Selesai'],
